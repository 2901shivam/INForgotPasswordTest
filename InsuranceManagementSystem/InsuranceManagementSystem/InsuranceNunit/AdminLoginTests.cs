...
namespace InsuranceNunit
{
    ...
    public class AdminLoginTests
    {
        ...
        private bool AdminExistsInDatabase(LoginView model)
        {
            ...
            var connectionString = "data source=SHIVAMSINGH;initial catalog=InsuranceDatabase;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework\" providerName=\"System.Data.SqlClient";
